...
if (0)
{
	$url = 'http://user:7WbQZedlAvzQ@35.204.73.93/elasticsearch/bslite/_doc/' . 'biostor-244024';
...
if (0)
{
	...
	$data = $elastic->send('GET', '_doc/' . urlencode('biostor-244024'));
